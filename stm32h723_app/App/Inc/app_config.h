...
/* Steel-ball position PID diagnostics, emitted through UART8 VOFA at 40 Hz. */
#define APP_H723_BALL_POSITION_VOFA_TELEMETRY_ENABLE 1U
#define APP_H723_BALL_POSITION_VOFA_TELEMETRY_INTERVAL_MS 25U
...
#define APP_H723_LINE_FOLLOW_PID_VOFA_TELEMETRY_INTERVAL_MS 10U
     ...
     (APP_H723_BALL_POSITION_VOFA_TELEMETRY_ENABLE == 1U)) > 1U
...
#error "APP_H723_BALL_POSITION_VOFA_TELEMETRY_ENABLE must be 0U or 1U"
#endif
#if (APP_H723_BALL_POSITION_VOFA_TELEMETRY_INTERVAL_MS == 0U)
#error "APP_H723_BALL_POSITION_VOFA_TELEMETRY_INTERVAL_MS must be nonzero"
#endif
...
#define APP_H723_LINE_FOLLOW_STICK_RANGE_MM_S 350.0f
#define APP_H723_REMOTE_BALL_SPEED_PROFILE_MAX_SPEED_MM_S \
    APP_H723_LINE_FOLLOW_STICK_RANGE_MM_S
#define APP_H723_REMOTE_BALL_SPEED_PROFILE_MAX_ACCEL_MM_S2 300.0f
#define APP_H723_REMOTE_BALL_SPEED_PROFILE_MAX_JERK_MM_S3 1500.0f
...
#define APP_H723_TASK4_CRUISE_SPEED_MM_S 300.0f
#define APP_H723_TASK4_ACCEL_MM_S2 100.0f
#define APP_H723_TASK4_DECEL_MM_S2 100.0f
#define APP_H723_TASK4_RUN_TIMEOUT_MS 8000U
#define APP_H723_TASK4_A_TO_B_DISTANCE_MM 1500.0f
#define APP_H723_TASK4_VEHICLE_LENGTH_MM 330.0f
/* 制动距离 = 300²/(2×100) = 450 mm */
#define APP_H723_TASK4_ACCEL_DISTANCE_MM 450.0f
#define APP_H723_TASK4_BRAKE_DISTANCE_MM 450.0f
...
#endif
/* 首次机械归零后，先移动到该相对输出轴位置，再允许手动水管倾角校准。 */
#ifndef APP_H723_PIPE_STARTUP_CALIBRATION_POSITION_DEG
#define APP_H723_PIPE_STARTUP_CALIBRATION_POSITION_DEG 134.0f
#endif
#ifndef APP_H723_PIPE_STARTUP_CALIBRATION_POSITION_TOLERANCE_DEG
#define APP_H723_PIPE_STARTUP_CALIBRATION_POSITION_TOLERANCE_DEG 1.0f
#endif
#ifndef APP_H723_PIPE_STARTUP_CALIBRATION_SPEED_TOLERANCE_RPM
#define APP_H723_PIPE_STARTUP_CALIBRATION_SPEED_TOLERANCE_RPM 5.0f
#endif
#ifndef APP_H723_PIPE_STARTUP_CALIBRATION_SETTLE_MS
#define APP_H723_PIPE_STARTUP_CALIBRATION_SETTLE_MS 200U
#endif
#ifndef APP_H723_PIPE_STARTUP_CALIBRATION_MOVE_TIMEOUT_MS
...
#endif
#if (APP_H723_K230_UART2_ENABLE != 0U) && (APP_H723_K230_UART2_ENABLE != 1U)
#error "APP_H723_K230_UART2_ENABLE must be 0U or 1U"
#endif
#if (APP_H723_BALL_POSITION_PERIOD_MS != 25U) || \
    (APP_H723_BALL_POSITION_SAMPLE_MAX_AGE_MS < APP_H723_BALL_POSITION_PERIOD_MS)
#error "Ball-position timing configuration is invalid"
#endif
