...
#ifndef APP_H723_JY901S_SERVICE_ENABLE
#define APP_H723_JY901S_SERVICE_ENABLE 0U
#endif

/* 保留的 JY901S 模块可通过 UART8 输出 VOFA+ JustFloat；服务关闭时禁止启用。 */
...
#error "APP_H723_JY901S_SERVICE_ENABLE must be 0U or 1U"
#endif
#if (APP_H723_JY901S_SERVICE_ENABLE == 0U) && \
    (APP_JY901S_VOFA_TELEMETRY_ENABLE != 0U)
#error "JY901S VOFA requires APP_H723_JY901S_SERVICE_ENABLE"
#endif
...
#define APP_TASK_MENU_PAGE_COUNT 6U
#define APP_TASK_MENU_FIRST_TASK_ID 2U
#define APP_TASK_MENU_BALANCE_SETUP_ID 7U
#define APP_TASK_MENU_KEY_DEBOUNCE_MS 120U

#define APP_H723_TASK3_START_TARGET_MM 125.0f
#define APP_H723_TASK3_MOVE_TARGET_MM 225.0f
#define APP_H723_TASK3_SWITCH_THRESHOLD_MM 175.0f
#define APP_H723_TASK3_FINISH_TARGET_MM 75.0f
...
/* Steel-ball position PID diagnostics, emitted through UART8 VOFA at 50 Hz. */
#define APP_H723_BALL_POSITION_VOFA_TELEMETRY_ENABLE 1U
#define APP_H723_BALL_POSITION_VOFA_TELEMETRY_INTERVAL_MS 20U
...
#endif
/* 首次机械归零后，先移动到该相对输出轴位置，再直接进入可用状态。 */
...
#endif
#if (APP_H723_BALL_POSITION_PERIOD_MS != 20U) || \
