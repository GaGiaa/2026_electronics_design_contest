...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOG, GRAY_AD0_Pin|GRAY_AD1_Pin|GRAY_AD2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : BUTTON_LOGIC_HIGH_Pin */
  ...
  /*Configure GPIO pins : BUTTON_PC4_Pin BUTTON_PC5_Pin */
  GPIO_InitStruct.Pin = BUTTON_PC4_Pin|BUTTON_PC5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : BUTTON_PA6_Pin */
  ...
  /*Configure GPIO pins : PG2 PG6 PG7 PG8
                           PG9 PG10 PG11 PG12
                           PG13 PG14 PG15 */
