...
$expectedDefaults = @{
    ...
    'APP_H723_PIPE_STARTUP_CALIBRATION_POSITION_DEG' = '134\.0f'
    'APP_H723_PIPE_STARTUP_CALIBRATION_POSITION_TOLERANCE_DEG' = '1\.0f'
    'APP_H723_PIPE_STARTUP_CALIBRATION_SPEED_TOLERANCE_RPM' = '5\.0f'
    'APP_H723_PIPE_STARTUP_CALIBRATION_SETTLE_MS' = '200U'
    'APP_H723_PIPE_STARTUP_CALIBRATION_MOVE_TIMEOUT_MS' = '10000U'
