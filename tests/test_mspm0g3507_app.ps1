...
foreach ($path in @($projectDir, $main, $ws2812, $ws2812Header, $buzzer, $buzzerHeader, $bmi160, $bmi160Header, $buttons, $buttonsHeader, $grayscale, $grayscaleHeader, $lineTracking, $lineTrackingHeader, $uart, $motor, $motorHeader, $encoder, $encoderHeader, $motorControl, $motorControlHeader, $motorPid, $motorPidHeader, $vofaJustFloat, $vofaJustFloatHeader, $syscfg, $rtosConfig, $ccsBuildConfig,
...
Assert-Contains -Path $main -Pattern '#if VOFA_SPEED_PID_TELEMETRY_ENABLE && GRAY_VOFA_TELEMETRY_ENABLE' -Description 'Speed and gray VOFA telemetry must be mutually exclusive'
...
Assert-Contains -Path $main -Pattern '#if IMU_TELEMETRY_ENABLE && !VOFA_SPEED_PID_TELEMETRY_ENABLE && !GRAY_VOFA_TELEMETRY_ENABLE' -Description 'VOFA modes must suppress IMU UART text'
...
Assert-NotContains -Path $main -Pattern 'gray,raw=' -Description 'Legacy gray text telemetry must be removed'
Assert-NotContains -Path $main -Pattern 'GRAY_TELEMETRY_ENABLE' -Description 'Legacy gray telemetry switch must be removed'
