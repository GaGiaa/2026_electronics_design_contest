...
foreach ($path in @($projectDir, $main, $ws2812, $ws2812Header, $buzzer, $buzzerHeader, $bmi160, $bmi160Header, $imuYaw, $imuYawHeader, $buttons, $buttonsHeader, $uart, $motor, $motorHeader, $encoder, $encoderHeader, $syscfg, $rtosConfig, $ccsBuildConfig,
...
Assert-Contains -Path $main -Pattern 'IMU telemetry and VOFA telemetry cannot be enabled together' -Description 'IMU and VOFA telemetry must be mutually exclusive'
