...
Assert-Contains -Path $syscfg -Pattern 'PWMRearLeft\.clockPrescale\s*=\s*2' -Description 'Rear-left motor timer must prescale 80 MHz to 40 MHz'
Assert-Contains -Path $syscfg -Pattern 'PWMRearRight\.clockDivider\s*=\s*2' -Description 'Rear-right motor timer must divide 80 MHz to 40 MHz'
