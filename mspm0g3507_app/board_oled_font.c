...
/* 5x7 printable ASCII font, stored one vertical column per byte. */
const uint8_t g_board_oled_font[BOARD_OLED_FONT_LAST_ASCII -
    ...
    {0x1FU, 0x20U, 0x40U, 0x20U, 0x1FU}, {0x7FU, 0x20U, 0x18U, 0x20U, 0x7FU},
    {0x63U, 0x14U, 0x08U, 0x14U, 0x63U}, {0x03U, 0x04U, 0x78U, 0x04U, 0x03U},
